...
mlflow.artifacts.download_artifacts(f'mlflow-artifacts:/0/e24f79a33c164947ac6378a2ec6f0ce2/artifacts/model/data/model.pth', dst_path = "./output")


#model = mlflow.pytorch.load_model(f'models:/{model_name}/{version}', dst_path = "./output")
