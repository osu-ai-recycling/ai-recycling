...
weights = 'D:/OSU_Repos/osu-ai-recycling/check_openvino_model' # TODO: Change me to path of the OpenVINO directory, not a specific file!
...
def send_image(video_path):
    ...
    # Alternatively, run detection on a single frame
    cap = cv2.imread(video_path)
    global current_frame
    current_frame = cap
    detect_and_display_img()
...
# # run cProfile
# cProfile.run('send_image(args.video_path)')
